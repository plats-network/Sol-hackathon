...
class PastTicketTab extends StatefulWidget {
  const PastTicketTab({Key? key}) : super(key: key);

  @override
  State<PastTicketTab> createState() => _PastTicketTabState();
}

class _PastTicketTabState extends State<PastTicketTab> {
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Image(
                          image: AssetImage(
                            getAssetImage(AssetImagePath.history),
                          ),
                      ...
                      verticalSpace4,
                      Text(
                        'When you have historys you’ll see them here.',
                        style: GoogleFonts.quicksand(
                          color: color4E5260,
                          fontSize: 13,
