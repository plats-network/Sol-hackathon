...
const double kMinInteractiveDimension = 40;
...
///
/// Used by [AppDropdownButton.selectedItemBuilder].
...
class AppDropdownButton<T> extends StatefulWidget {
  ...
  ///
  /// If the [onChanged] callback is null or the list of [AppDropdownButton.items]
  /// is null then the dropdown button will be disabled, i.e. its arrow will be
  /// displayed in grey and it will not respond to input. A disabled button
  /// will display the [AppDropdownButton.disabledHint] widget if it is non-null.
  /// If [AppDropdownButton.disabledHint] is also null but [AppDropdownButton.hint] is
  /// non-null, [AppDropdownButton.hint] will instead be displayed.
  /// {@endtemplate}
...
class _AppDropdownButtonState<T> extends State<AppDropdownButton<T>> with WidgetsBindingObserver {
  int? _selectedIndex;
