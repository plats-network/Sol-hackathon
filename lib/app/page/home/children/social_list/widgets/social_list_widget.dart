...
class SocialListWidget extends StatelessWidget {
  ...
  const SocialListWidget({Key? key, required this.tasks}) : super(key: key);
                    ...
                    return GestureDetector(
                      ...
                      onTap: () {
                        Get.toNamed(
                          ...
                          arguments: {'task_id': tasks[index].id, 'is_done': tasks[index].isDone},
                        );
                      },
                    );
                  },
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(
                        ...
                        bottom: dimen2),
                    child: Text(
                      'social_task'.tr.capitalizeFirst.toString(),
